...
export default function Footer() {
  return (
    <footer className="bg-[#0f0a1a] text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Advanced image compression technology that reduces file size without compromising quality.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="#features" className="text-gray-400 hover:text-purple-300 transition-colors">Features</Link></li>
              <li><Link href="#how-it-works" className="text-gray-400 hover:text-purple-300 transition-colors">How It Works</Link></li>
              <li><Link href="#" className="text-gray-400 hover:text-purple-300 transition-colors">Pricing</Link></li>
